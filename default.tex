		...
		\begin{enumerate}
			...
			\item El campo eléctrico en el origen de coordenadas.
				\begin{align*}
					...
					%
					\vec{E}_1 &= \Big{(} \frac{-81}{13^{ \frac{3}{2} }}\hat{\imath}-
					...
					(2\hat{\jmath}-5\hat{k})\\
					%
					\vec{E}_2 &= \Big{(} \frac{-18}{29^{ \frac{3}{2} }}\hat{\jmath}+
					\frac{45}{29^{ \frac{3}{2} }}\hat{k}
					\Big{)}*10^3\frac{N}{C}\\
					\\
					%
					\vec{E}_t &=  \Big{(} \frac{-81}{13^{ \frac{3}{2} }}\hat{\imath}-
					\frac{54}{13^{ \frac{3}{2} }} \hat{\jmath}
					\Big{)}*10^3\frac{N}{C}+
			...
			\item La fuerza eléctrica sobre la carga $q_3(-2\mu C)$,
				...
				\begin{align*}
					...
					(-3\hat{\imath}-2\hat{\jmath})\\
					%
					\vec{F}_{1\_3} &= \Big{(} \frac{162}{13^{ \frac{3}{2} }} \hat{\imath}+
					...
					\Big{(} \frac{(-3\hat{\imath}-2\hat{\jmath})\cancel{m}}{\sqrt{29}\cancel{m}} \Big{)}\\
				\end{align*}
		\end{enumerate}
