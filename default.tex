	...
	\item Dos cargas puntuales $q_1(+3\mu C)$ y $q_2(-1\mu C)$
		...
		\begin{enumerate}
			\item La fuerza eléctrica que ejerce la carga $q_1$ sobre $q_2$.
				\begin{align*}
					F &= k \frac{q_1q_2}{r^2}\\
					F &= 9*10^9 \frac{N\cancel{m^2}}{\cancel{\cancel{C}^2}}*
					\frac{3*10^{-6}\cancel{C}*-1*10^{-6}\cancel{C}}{(9+16+25)\cancel{m^2}}\\
					F &= \frac{-27*10^{-3}N}{50}\\
					\Aboxed
					{
						F &= \frac{-27}{5} * 10^{-4}N
			...
			\item El campo eléctrico en el origen de coordenadas.
				\begin{align*}
					...
					\Big{(}\frac{(0-A_x)\hat{\imath};(0-A_y)\hat{\jmath};(0-A_z)\hat{k}}{r_1}\Big{)}\\
					\vec{E}_1 &= 9*10^{9} \frac{N\cancel{m^2}}{C^2}*
					\frac{3*10^{-6}C}{(9+4)\cancel{m^2}}*
					\Big{(} \frac{-3\hat{\imath};-2\hat{\jmath}}{\sqrt{9+4}} \Big{)}\\
					\vec{E}_1 &= \frac{27}{13}*10^3\frac{N}{C}
					\Big{(} \frac{-3\hat{\imath};-2\hat{\jmath}}{\sqrt{13}} \Big{)}\\
					\vec{E}_1 &=
				\end{align*}
